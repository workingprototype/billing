...
class Purchase
{
  ...
  public function form()
  {
    ...
    function disc(a){
      ...
      ex.value=parseFloat(cgstaz)+parseFloat(sgstaz)+parseFloat(netamountz);
      margin(a);
    }
    function remove(no){
	...
	<td><select id=\"uom'+r+'_'+f+'\" style=\"width:80px\" ><option default=\'deafault\'>'+g+'</option>$options</select></td>\
        ...
        <td><input value=\"0\" id=\"cess'+r+'_'+f+'\" style=\"width:150px\" onkeyup=\"uombase(\''+r+'_'+f+'\')\" placeholder=\'\'></td>\
