...
<body>
	...
	<div class="module">
							...
							<h3>Expanded Pending Orders View</h3>
							</div>
...
<button onclick="location.href = '/billing/pendingorders';"> Return to Pending Order Tracking </button>
