...
<head>
	...
	<link type="text/css" href="./shopping/admin/icons/css/font-awesome.css" rel="stylesheet">
...
?>
										<tr>
											...
											<td>    <a href="./shopping/admin/delivered-orders-expanded.php?orderNumber=<?php echo htmlentities($row['orderNumber']);?>" title="Update order" target="_blank"><i class="icon-edit"></i></a>
											</td>
											</tr>
...
<button onclick="location.href = './purchase';"> Return to Billing </button>
	...
	<script src="./shopping/scripts/jquery-1.9.1.min.js" type="text/javascript"></script>
	<script src="./shopping/scripts/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>
	<script src="./shopping/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
	<script src="./shopping/scripts/flot/jquery.flot.js" type="text/javascript"></script>
	<script src="./shopping/scripts/datatables/jquery.dataTables.js"></script>
	<script>
