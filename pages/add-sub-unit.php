...
if(isset($_POST['submit']))
{
	$uom=$_POST['uom'];
	$subuom=$_POST['subuom'];
	$qtyinsubuom=$_POST['qtyinsubuom'];
$sql=mysqli_query($con,"insert into subuom(uomid,subuom,qtyinsubuom) values('$uom','$subuom','$qtyinsubuom')");
$_SESSION['msg']="Sub Unit & Quantity in each Defined !!";

}

if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from subuom where id = '".$_GET['id']."'");
...
<div class="control-group">
<label class="control-label" for="basicinput">Create Sub Unit</label>
<div class="controls">
<input type="text" placeholder="Enter Sub Unit of Measurement"  name="subuom" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Quantity in this sub unit</label>
<div class="controls">
<input type="text" placeholder="Enter Quantity in this unit"  name="qtyinsubuom" class="span8 tip" required>
</div>
</div>
