...
while($row=mysqli_fetch_array($query))
{
	$content.='
										<tr>
											...
											<td>
											<a href="./shopping/admin/edit-retailer.php?id='.$row['id'].'" ><i class="icon-edit"></i></a>
											<a href="./shopping/admin/delete-retailer.php?id='.$row['id'].'&del=delete" onClick="return confirm(\'Are you sure you want to delete?\')"><i class="icon-remove-sign"></i></a></td>
										</tr>';
										$cnt=$cnt+1; }
...
$page->var['title']="Manage Retailer Info";
$page->render();
?>
