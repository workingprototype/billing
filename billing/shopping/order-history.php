			...
			<thead>
				<tr>
					<th class="cart-romove item">#</th>
  					<th class="cart-romove item">OrderNumber</th>
...
<?php $query=mysqli_query($con,"select products.productImage1 as pimg1,products.productName as pname,products.id as proid,orders.productId as opid,orders.quantity as qty,products.productPrice as pprice,products.shippingCharge as shippingcharge,orders.paymentMethod as paym,orders.orderDate as odate,orders.id as orderid, orders.OrderNumber as UniqueOrderNumber from orders join products on orders.productId=products.id where orders.userId='".$_SESSION['id']."' and orders.paymentMethod is not null");
$cnt=1;
...
?>
				<tr>
					<td><?php echo $cnt;?></td>
          <td class="cart-ordernumber">
							<?php echo $orderNumber=$row['UniqueOrderNumber']; ?>
					</td>
					<td class="cart-image">
