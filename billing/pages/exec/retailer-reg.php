...
$query=mysqli_query($con,"insert into retailer(name,email,contactno,altcontactno,password,shippingAddress,billingAddress) values('$name','$email','$contactno','$altcontactno','$password','$shippingAddress','$billingAddress')");
if($query)
{
...
<div class="col-md-6 col-sm-6 create-new-account">
	<h4 class="checkout-subtitle">Create a new Retailer Account</h4>
...
<div class="form-group">
      	    	<label class="info-title" for="password">Create Password. <span>*</span></label>
